                ...
                <AccordionItem value="item-3" className="bg-white dark:bg-gray-800 rounded-lg shadow-sm">
                  ...
                  <AccordionContent className="px-6 pb-4">
                    <div className="flex flex-col md:flex-row gap-4 items-start">
                      <div className="flex-1">
                        <p className="text-gray-600 dark:text-gray-300">
                          Communion is designed to help you connect with like-minded individuals from diverse
                          backgrounds. Our events, both virtual and in-person, provide excellent opportunities to meet
                          new people who share your interests or who can offer fresh perspectives. Many of our users
                          have formed lasting friendships and professional connections through our platform.
                        </p>
                      </div>
                      <div className="md:w-1/3 rounded-lg overflow-hidden">
                        <img
